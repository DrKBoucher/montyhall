...
#' @title
#' Select a door from the previously created game.
#'
#' @description
...
#'   doors at the beginning of the game. He/she does not know the location of the
#'   car or the goats.
#'
#' @param ... no arguments are used by the function.
#'
...
#' @title
#' A confirmed goat door is opened.
#'
#' @description
#'   `open_goat_door()` picks a second door that definitely has a goat behind it
#'   from the remaining two that were not selected from the `select_door()`
#'   function.
#'
#' @details
#'   This function reveals a goat for the contestant. The game host opens one of
#'   the remaining two doors that has a goat behind it.
#'
#' @param
...
#' @title
#' An entire round of Let's Make a Deal is played
#'
#' @description
